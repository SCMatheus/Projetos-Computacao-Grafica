...
void display()
{
    ...
    glTranslated(0., 0., -3.);
    glBegin(GL_POLYGON);
    glTexCoord2d(1.0, 1.0); glVertex3d( 1.0, 1.3, 0.0);
    glTexCoord2d(0.0, 0.0); glVertex3d(0,1.4, 0.0);
    glTexCoord2d(0.0, 1.0); glVertex3d(-1.0, 0.7, 0.0);
    glTexCoord2d(1.0, 0.0); glVertex3d( 0.2,0.5, 0.0);
    glEnd();
    glBegin(GL_POLYGON);
    glTexCoord2d(0.0, 1.0); glVertex3d(-1.0, 0.7, 0.0);
    glTexCoord2d(0.0, 0.0); glVertex3d(0.2,0.5, 0.0);
    glTexCoord2d(1.0, 1.0); glVertex3d( 0.4, -0.9, 0.0);
    glTexCoord2d(1.0, 1.0); glVertex3d( -0.7, -0.9, 0.0);
    glEnd();
    glBegin(GL_POLYGON);
    glTexCoord2d(1.0, 1.0); glVertex3d( 0.4, -0.9, 0.0);
    glTexCoord2d(0.0, 0.0); glVertex3d(0.2,0.5, 0.0);
    glTexCoord2d(1.0, 1.0); glVertex3d( 1.0, 1.3, 0.0);
    glTexCoord2d(0.0, 0.0); glVertex3d(1.2,-0.2, 0.0);
    glEnd();
    glPopMatrix();
    iniciar();
    glutPostRedisplay();
